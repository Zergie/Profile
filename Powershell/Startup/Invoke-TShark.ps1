# TShark (Wireshark) 4.0.10 (v4.0.10-0-gf5c7c25a81eb)
...
#                            (default: C:\Users\PUCHIN~1.000\AppData\Local\Temp)
#
# Diagnostic output:
...
$cmd = ". 'C:\Program Files\Wireshark\tshark.exe' $arguments"
Write-Host -ForegroundColor Cyan $cmd
Invoke-Expression $cmd #| ForEach-Object { $_ }
