            ...
            while ($true) {
                ...
                try {
                    ...
                    try {
                        ...
                        Write-GitPromptWatcherWorkerEvent -IdentityKey $Identity.Key -Event 'pipe.response' -CorrelationId $correlationId -Data @{ requestType = [string]$message.type; outcome = [string]$response.state }
